...
- Choose **Up to Next Major** for the version rule and set the version to **1.1.5**.
...
```swift
dependencies: [
    .package(url: "https://github.com/hainayanda/Dummyable.git", .upToNextMajor(from: "1.1.5"))
]
```
